...
from imageio.helpers import plot_qimage_grayscale, lr_decay
...
#         ax1 = plt.subplot(gs[1])
    ...
    def prepare_data(self, dataset, partitioning=(6, 2, 2), partial=100):
        ...
        if self.dataset_manager.dataset_available(stored_ds_name):
            ...
            sets = create_samples(dataset, partitioning, partial)
